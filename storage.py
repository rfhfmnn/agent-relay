...
Claim, heartbeat, terminal submission, and recovery each use an atomic
transaction seam, leveraging PostgreSQL row-locking operations (FOR UPDATE SKIP LOCKED)
or SQLite serialized writer transactions.
"""
